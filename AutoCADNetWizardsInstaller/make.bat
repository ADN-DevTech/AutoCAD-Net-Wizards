...
if exist AutoCAD_2014_dotnet_wizards.zip del AutoCAD_2015_dotnet_wizards.zip > nul
"C:\Program Files\WinRAR\WinRAR.exe" a AutoCAD_2015_dotnet_wizards.zip AutoCADNetWizards.msi > nul
